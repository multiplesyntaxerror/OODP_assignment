...
public class MenuController extends Controller {
	...
	public void createMenuItem() {
		...
		while(true) {
			...
			} while (name.isEmpty() || !name.matches("[a-zA-Z0-9\\s'&]+"));
			...
			if (item == null) {
				...
				do {
					...
					if (!description.matches("[a-zA-Z0-9\\s',&]+"))
						getGui().displayStringsB("SYSTEM MESSAGE: Your Input Is Invalid.\n");
				} while (description.isEmpty() || !description.matches("[a-zA-Z0-9\\s',&]+"));
		...
		if (item != null) {
			...
			do {
				...
				if (!newName.matches("[a-zA-Z0-9\\s',&]+"))
					getGui().displayStringsB("SYSTEM MESSAGE: Your Input Is Invalid.\n");
			} while (newName.isEmpty() || !newName.matches("[a-zA-Z0-9\\s',&]+"));
			...
			do {
				...
				if (newDescription.isEmpty())
					getGui().displayStringsB("Please Enter Something.\n");
				if (!newDescription.matches("[a-zA-Z0-9\\s',&]+"))
					getGui().displayStringsB("SYSTEM MESSAGE: Your Input Is Invalid.\n");
			} while (newDescription.isEmpty() || !newDescription.matches("[a-zA-Z0-9\\s',&]+"));
